...
It is kept here as the reference oracle for the modern reimplementation and is
never edited. See [`../REVIVAL.md`](../REVIVAL.md) for the analysis of what this
code contains and how it maps to the new implementation.
